...
"""
import random
a = random.sample(range(1,100),random.randint(1,99))
b = random.sample(range(1,100),random.randint(1,99))
longer = max(a,b)
shorter = min(a,b)
c=[i for i in longer if i in shorter]
print("List A: \n" + str(a) +"\n\n" + "List B: \n" + str(b) + "\n")
print("Your new list: " + str(c))
